export default {
  ...
  // ========== Index Page ==========
  index: {
    heroTitle: 'Precision Manufacturing · Quality Assurance',
    heroText: 'Specializing in communication antenna components and precision hardware stamping, serving global leading enterprises with stable craftsmanship and reliable delivery.',
    // Main Business
  ...
  example: {
    pageTitle: 'Partners',
    pageSubtitle: 'Trusted by leading communication and technology enterprises worldwide.',
    sectionTitle: 'Cooperation Partners',
    sectionDesc: 'We maintain long-term stable partnerships with top-tier communication and technology companies, providing high-quality precision components.'
  },

  // ========== News Page ==========
  news: {
    pageTitle: 'Company News',
    pageSubtitle: 'Sharing the latest information and industry trends in products, manufacturing, cooperation and services.',
    sectionTitle: 'Latest News',
    sectionDesc: 'Strategic cooperation signing ceremony and national cross-screen action launch conference were successfully held in Beijing.',
    readMore: 'Read More'
  },
